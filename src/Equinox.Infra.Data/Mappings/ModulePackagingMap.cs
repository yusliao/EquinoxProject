...
{
    public class ModulePackagingMap : IEntityTypeConfiguration<ModulePackaging>
    {
        public void Configure(EntityTypeBuilder<ModulePackaging> builder)
        {
            ...
            builder.Property(c => c.ModuleCode)
                .HasColumnType("varchar(100)")
                .HasMaxLength(100)
                .IsRequired();

            builder.Property(c => c.PackCode)
                .HasColumnType("varchar(100)")
                .HasMaxLength(100)
                .IsRequired();
